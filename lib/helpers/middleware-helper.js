...
class MiddlewareHelper {
  ...
  */
  getRouteMiddleware(route) {
    ...
    middleware = middleware.concat(route.middleware.all).concat(route.middleware.only);
  ...
  _validateMiddleware(route) {
    ...
    if (Array.isArray(route.middleware)) { // is array?
      ...
      if (
        ...
        !Array.isArray(route.middleware.only) ||
